...
para.lambdac = 0.5 ;         % lambda = lambdac / sqrt(m) for ||E||_1

trainImageNum = 50;                 % train image number for each category
testImageNum  = 100 - trainImageNum; % test image number for each category
...
para.beta = 1;             % equal to the number of class
...
[trainImages, testImages, trainTransform, testTransform] = get_images_dummy(imagePath, para, transformationInit);
