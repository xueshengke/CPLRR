...
% for windows images
para.imageSize = [ 30  20 ];
para.coordinate = [ 5  26 ; ...
                   11  11 ];
...
testImageNum  = 15 - trainImageNum; % test image number for each category
...
[trainImages, testImages, trainTransform, testTransform] = get_images_GTF(imagePath, para, transformationInit);
