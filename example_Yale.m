...
testImageNum  = 30;    % test image number for each category
...
para.beta = 15;            % equal to the number of class
...
[trainImages, testImages, trainTransform, testTransform] = get_images_Yale(imagePath, para, transformationInit);
