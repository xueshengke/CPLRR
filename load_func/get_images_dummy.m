function [trainImages, testImages, trainTransform, testTransform] = get_images_dummy( ...
...
%--------------------------------------------------------------------------
%     load images of dummy face images
% 
%     Inputs:
