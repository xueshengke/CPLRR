function [trainImages, testImages, trainTransform, testTransform] = get_images_GTF( ...
...
for i = 1 : classNum
    imageNum = size(gtfData{i}, 3);
    normGTF{i} = zeros(imgSize(1), imgSize(2), imageNum);
    tmp= gtfData{i} / 255;
