...
destRoot = fullfile(currentPath, 'results', 'mnist') ;
for i = 1 : classNum
...
testImageNum  = 200;    % test image number for each category
...
[trainImages, testImages, trainTransform, testTransform] = get_images_MNIST(imagePath, para, transformationInit);
